...
const steps = [
  {
    ...
    description: 'Penyu betina naik ke pantai Enggano pada malam hari untuk bertelur. Satu sarang dapat berisi 80–120 butir telur. Musim bertelur berlangsung dari bulan Oktober hingga Februari.',
    details: [
  ...
  },
  {
    ...
    description: 'Tim konservasi mengumpulkan telur dari sarang alami dan memindahkannya ke tempat penetasan buatan (hatchery) berukuran 5m × 8m untuk melindungi dari predator dan pencurian.',
    details: [
  ...
  },
  {
    ...
    description: 'Setelah 45-60 hari, tukik menetas dari telur. Tukik yang baru menetas berukuran sekitar 5 cm dan sangat rentan terhadap predator. Di alam liar, hanya 1 dari 1.000 tukik yang bertahan hidup.',
    details: [
      'Ukuran tukik: ~5 cm',
  ...
  },
  {
    ...
    description: 'Tukik dipindahkan ke 4 kolam keramba jaring (5m × 5m, 4 sekat) di perairan Bak Blau. Jaring sedalam 2m (1.5m terendam) menjaga tukik tetap aman sambil terpapar air laut alami.',
    details: [
      '4 kolam keramba: 5m × 5m',
      '4 sekat per kolam (2.5m × 2.5m)',
      'Jaring 2m, terendam 1.5m',
      'Kapasitas total: 200 tukik',
  ...
  },
  {
    ...
    description: 'Setelah tukik mencapai ukuran 15-20 cm dan dinyatakan sehat, mereka dilepasliarkan ke laut. Dengan program pembesaran ini, survival rate meningkat dari 0.1% menjadi 30-50%.',
    details: [
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(160deg, rgba(15,23,42,0.95) 0%, rgba(30,41,59,0.95) 50%, rgba(15,23,42,0.95) 100%)',
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 z-20 bg-white/[0.06] hover:bg-white/[0.12] border border-white/[0.08] rounded-full p-2 transition-all"
        >
        ...
        <div className="px-5 pt-5 sm:px-7 sm:pt-6">
          ...
          <p className="text-white/30 text-[11px] sm:text-xs mt-0.5">
            ...
            {steps.map((step, i) => (
              <React.Fragment key={step.id}>
                <button
                  ...
                  className={`relative group shrink-0 flex items-center justify-center transition-all duration-500 ${
                    i === activeStep ? 'w-10 h-10 sm:w-11 sm:h-11' : 'w-7 h-7 sm:w-8 sm:h-8'
                  }`}
                >
                  <div
                  ...
                  <span className={`relative z-10 transition-all duration-300 ${
                    i === activeStep ? 'text-lg sm:text-xl' : 'text-sm sm:text-base'
                  }`}>
                    {step.icon}
                  </span>
                </button>
                {i < steps.length - 1 && (
                  <div className="flex-1 h-px mx-0.5 rounded-full" style={{
        ...
        <div className="px-5 sm:px-7 pb-5 sm:pb-6 overflow-auto" style={{ maxHeight: 'calc(92vh - 180px)' }}>
          <div className={`rounded-2xl p-4 sm:p-5 bg-gradient-to-br ${current.gradient} border ${current.borderColor} transition-all duration-500`}>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="min-w-0">
                ...
                <h3 className="text-base sm:text-lg font-bold text-white leading-tight">{current.title}</h3>
          ...
          <div className="flex items-center justify-between mt-4">
            <button
              ...
              className={`flex items-center gap-1 px-3 py-2 rounded-lg text-[11px] sm:text-xs font-semibold transition-all ${
                activeStep === 0
